...
/**
 * MVP 소스 시드 정의 (MVP-DESIGN §1) — dev/ai/econ 토픽별 3종 이상 10종(한국어 5 · 영어 5).
 * <p>
 * 모든 url은 실제 응답으로 검증했다(HTTP 200 + RSS/Atom 루트 태그 + 최근 갱신 확인).
 ...
 * {@code RssFeedAdapter}의 Atom 경로는 네이버 D2 피드 픽스처로 검증한다.
 */
final class SourceSeedData {
    ...
    static List<Source> sources() {
        return List.of(
                ...
                Source.create("네이버 D2", SourceType.RSS,
                        "https://d2.naver.com/d2.atom", "ko", Category.PROGRAMMING, true),
